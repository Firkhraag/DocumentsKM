    ...
    public class ConstructionElementRepoTest
    {
        ...
        public void Add_ShouldAddConstructionElement()
        {
            ...
            var constructionElement = new ConstructionElement
            {
                ...
                Weight = 1.0f,
                SurfaceArea = 1.0f,
                ProfileType = TestData.profileTypes.SingleOrDefault(
                    v => v.Id == profileTypeId),
        ...
        public void Update_ShouldUpdateConstructionElement()
        {
            ...
            constructionElement.ProfileName = "NewUpdate";

            // Act
            repo.Update(constructionElement);

            // Assert
            Assert.Equal(constructionElement.ProfileName, repo.GetById(id).ProfileName);
